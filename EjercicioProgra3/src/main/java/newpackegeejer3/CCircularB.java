...
public void mostrar() {
    ...
    CCircularB aux = new CCircularB();  // auxiliar para guardar elementos
    CCircularB temp = new CCircularB(); // auxiliar temporal para buscar el menor
...
public void vaciar(CCircularB c){
    while (!c.esvacia()){
